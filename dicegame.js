...
function throws(arg)
{
 ...
 }else if(tt=="TWO")
 {
    ...
    {
      document.frm.dimg1.src="./images/dice.gif";
      document.frm.dimg2.src="./images/dice.gif";

    }else{
      document.frm.dimg1.src="./images/dice"+dice()+".gif";
      document.frm.dimg2.src="./images/dice"+dice()+".gif";
    }
  }else{
    document.getElementById("im1").style.visibility="visible";
    document.getElementById("im2").style.visibility="visible";
    ...
    if(arg=="rot")
    {
      document.frm.dimg1.src="./images/dice.gif";
      document.frm.dimg2.src="./images/dice.gif";
      document.frm.dimg3.src="./images/dice.gif";
    }else{
     document.frm.dimg1.src="./images/dice"+dice()+".gif";
     document.frm.dimg2.src="./images/dice"+dice()+".gif";
     document.frm.dimg3.src="./images/dice"+dice()+".gif";
    }}}
